...
import { submitGrade, pollGradingStatus, getActiveGradingJob, getEssayText } from '../lib/gas'
import { startPolling } from '../lib/polling'

export type GradingStatus = 'idle' | 'submitting' | 'polling' | 'done' | 'error'
...
export async function startGrading(): Promise<void> {
  if (gradingStatus.value === 'submitting' || gradingStatus.value === 'polling') return
...
async function onGradingComplete(result: GradeResult): Promise<void> {
