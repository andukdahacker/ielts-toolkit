...
describe('SheetInfo', () => {
  ...
  it('displays sheet name as link', () => {
    linkedSheet.value = { id: 'abc', name: 'My Score Sheet', url: 'https://docs.google.com/spreadsheets/d/abc' }
    render(<SheetInfo />)
  ...
  it('displays student count', () => {
    linkedSheet.value = { id: 'abc', name: 'Sheet', url: 'https://docs.google.com/spreadsheets/d/abc' }
